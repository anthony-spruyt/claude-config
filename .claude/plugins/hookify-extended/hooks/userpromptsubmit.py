#!/usr/bin/env python3
"""UserPromptSubmit hook executor for hookify-extended.

Evaluates rules when user submits a prompt.
...
def main():
    ...
    rules = load_rules(event="user_prompt", rules_dir=str(rules_dir), include_disabled=False)
