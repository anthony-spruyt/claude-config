...
4. **Hookify-Plus Plugin** ([hookify-plus](https://github.com/adrozdenko/hookify-plus)) - Community fork of official hookify that fixes [#12446](https://github.com/anthropics/claude-code/issues/12446) and adds rate-limited warnings
...
The official hookify plugin has a bug ([#12446](https://github.com/anthropics/claude-code/issues/12446)) where messages don't reach Claude. We use [hookify-plus](https://github.com/adrozdenko/hookify-plus) (community fork) with our contributions:
...
**Hookify tests:** Add test cases to [tests/hooks/hookify_test_cases.yaml](tests/hooks/hookify_test_cases.yaml) with expected outcome (block/warn/allow). Tests use hookify-plus from the cloned fork.
